...
module ImageAttachments
  ...
  class Error < StandardError
    ...
    MESSAGES = {
      ...
      "invalid_idempotency_key" => "The image comment idempotency key is invalid.",
      "invalid_project" => "The image comment project is invalid.",
      "invalid_body" => "Image comments require a text body.",
      "missing_image" => "Exactly one image is required.",
      "too_many_images" => "Only one image may be attached.",
      ...
      "content_digest_mismatch" => "The image bytes do not match the declared digest.",
      "idempotency_conflict" => "That image comment key was already used for different content.",
