...
Changes to authentication, authorization, persistence, deployment, or release behavior also need focused regression tests through the adapter-neutral Active Record contract and each affected edition. Browser-facing changes need system coverage for keyboard use, narrow screens, and the affected multi-user flow.
