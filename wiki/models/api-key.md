...
- REST API project guards treat the associated project as required at request time. If a stale key cannot resolve a project, `require_current_project!` returns a forbidden JSON error instead of raising on a nil project.
